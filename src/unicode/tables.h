 ...
 *
 * Unicode tables definitions.
 *
 * Implementation is based on Golang 1.15.8: unicode/tables.go
 */
...
// The original implementation is in Golang 1.15.8: unicode/tables.go
static inline const RangeTable WHITE_SPACE = {
	.r16 = {
		{0x0009, 0x000d, 1},
		{0x0020, 0x0085, 101},
		{0x00a0, 0x1680, 5600},
...
inline static const std::vector<uint16_t> ASCII_FOLD = {
	0x0000,
	0x0001,
	0x0002,
	0x0003,
...
inline static const std::vector<FoldPair> CASE_ORBIT = {
	{0x004B, 0x006B},
	{0x0053, 0x0073},
	{0x006B, 0x212A},
	{0x0073, 0x017F},
...
inline static const std::vector<CaseRange> CASE_RANGES = {
